...
def run_single_benchmark(L: int, mode: str, dis_type: str, method: str, d: float, p: int,
    ...
    if mode == "adaptive":
        ...
        # Apply Hybrid-style mixed-precision buffering inside adaptive (copy routines only).
        # Disable by setting PYFLOW_ADAPTIVE_MP=0 externally.
        env.setdefault("PYFLOW_ADAPTIVE_MP", "1")
    ...
    cmd = [
        sys.executable,
        str(CODE_DIR / "main_itc_cpu_d2 copy.py"),
