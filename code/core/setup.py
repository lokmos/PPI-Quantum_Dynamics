...
This file compiles the Cython script "dyn_cython.pyx" into the module "dyn_cython" which may 
...
setup(
  name = 'dyn_cython',
  ext_modules=[
    Extension('dyn_cython', ['dyn_cython.pyx'],include_dirs=[numpy.get_include()],extra_compile_args = ["-ffast-math","-fopenmp"],extra_link_args=['-fopenmp'])
    ],
